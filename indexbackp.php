...
<head>
  ...
  <title>Infra Dashboard 2.0 | Log in</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="index.php"><b>Infra Dashboard</b> 2.0</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form class="" action="" method="post">
        ...
        <div class="row">
          ...
          <div class="col-12" style="margin-bottom: 5px">
            <button id="refresh" type="submit" name="login" class="btn btn-primary btn-block">Acessar a Dashboard</button>
          </div>
      ...
      <!-- /.social-auth-links -->
<?php
      /* <!-- Caso for precisar ter alguma sugestão de adicionar manualmente. -->
